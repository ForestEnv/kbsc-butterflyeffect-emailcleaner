...
db.selectID = require("./admin")(sequelize, Sequelize);
...
db.Admin.hasMany(db.Admin, { foreignKey: "admin_no", sourceKey: "no" });
db.selectID.belongsTo(db.Admin, { foreignKey: "admin_no" });
